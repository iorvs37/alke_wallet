...
Alke Wallet es una billetera digital que permita a los usuarios gestionar sus activos financieros de manera segura y conveniente.
    ...
    permitirá a los usuarios loguearse, agendar contactos para futuras transferencias, realizar movimientos y transacciones dentro de la misma web 
    
    Herramientas a usar:
    HTML, CSS, JavaScript, Bootstrap y JQuery
